...
A real-time hand gesture recognition system that enables controlling
operating system mouse actions using computer vision and machine learning.

The system uses a webcam feed to detect hand landmarks, classify hand gestures,
and map them to OS-level mouse movements and click actions.
